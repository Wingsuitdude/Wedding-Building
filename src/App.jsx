          ...
          <div className="max-w-4xl mx-auto relative z-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm p-6 md:p-8 rounded-xl shadow-lg border border-rose-900/20">
                <h3 className="text-2xl md:text-3xl font-bold text-rose-400 mb-4 md:mb-6">Ceremony</h3>
              ...
              <div className="bg-gray-900/50 backdrop-blur-sm p-6 md:p-8 rounded-xl shadow-lg border border-rose-900/20">
                ...
                <div className="space-y-3 md:space-y-4 text-gray-300">
                  ...
                  <p className="text-lg md:text-xl font-semibold ml-7">
                    Arrive by April 18th
                  </p>
                </div>
              </div>
